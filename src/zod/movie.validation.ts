...
export const movieFormSchema = z.object({
	...
	rentPrice: z.coerce.number().min(0, "Rent price must be 0 or greater").optional().or(z.literal("")),
	buyPrice: z.coerce.number().min(0, "Buy price must be 0 or greater").optional().or(z.literal("")),
});
