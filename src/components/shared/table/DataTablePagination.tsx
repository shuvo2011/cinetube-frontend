...
const DataTablePagination = <TData,>({ table, totalRows, totalPages, isLoading }: DataTablePaginationProps<TData>) => {
			...
			<div className="flex flex-wrap items-center gap-2 text-sm text-muted-foreground">
				...
				{showCustomInput && (
					<div className="flex items-center gap-2">
						...
						/>
						<Button size="sm" variant="outline" onClick={applyCustomPageSize} disabled={isLoading}>
							Apply
						</Button>
					</div>
				)}
